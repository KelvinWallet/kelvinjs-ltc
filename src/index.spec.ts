import { ltcCurrencyUtil } from './index';

describe('offline utilities', () => {
  test('getSupportedNetworks', () => {
    const f = ltcCurrencyUtil.getSupportedNetworks;
    expect(f()).toStrictEqual(['mainnet', 'testnet']);
  });

  test('getFeeOptionUnit', () => {
    const f = ltcCurrencyUtil.getFeeOptionUnit;
    expect(f()).toBe('sat/kB');
  });

  test('isValidFeeOption', () => {
    const f = ltcCurrencyUtil.isValidFeeOption;

    // the network must be correct
  ...
  test('isValidAddr', () => {
    ...
    const f = ltcCurrencyUtil.isValidAddr;
  ...
  test('isValidNormAmount', () => {
    const f = ltcCurrencyUtil.isValidNormAmount;
  ...
  test('convertNormAmountToBaseAmount', () => {
    const f = ltcCurrencyUtil.convertNormAmountToBaseAmount;
  ...
  test('convertBaseAmountToNormAmount', () => {
    const f = ltcCurrencyUtil.convertBaseAmountToNormAmount;
  ...
  test('getUrlForAddr', () => {
    ...
    const f = ltcCurrencyUtil.getUrlForAddr;
  ...
  test('getUrlForTx', () => {
    ...
    const f = ltcCurrencyUtil.getUrlForTx;

    const M_TXID =
      '0ae3e52cb6d816b03c6c91d92cac8f2f7f615264c5c3452bdfaf128d3f726062';
    const T_TXID =
      'a7617369d433291fa88afac61f2b0719fbd364ceea50441650e2c6dd0e666cf6';
  ...
  test('encodePubkeyToAddr', () => {
    const f = ltcCurrencyUtil.encodePubkeyToAddr;
  ...
  test('getHistorySchema', () => {
    // Question: What should be tested?
    const f = ltcCurrencyUtil.getHistorySchema;
    expect(f().length).toBe(4);
  });

  test('getPreparedTxSchema', () => {
    // Question: What should be tested?
    const f = ltcCurrencyUtil.getPreparedTxSchema;
  ...
  test('prepareCommandGetPubkey', () => {
    const f = ltcCurrencyUtil.prepareCommandGetPubkey;
    for (const n of ['mainnet', 'testnet']) {
  ...
  test('prepareCommandShowAddr', () => {
    const f = ltcCurrencyUtil.prepareCommandShowAddr;
    for (const n of ['mainnet', 'testnet']) {
      expect(() => f(n, 0)).not.toThrow();
      expect(() => f(n, 1)).not.toThrow();
      expect(() => f(n, 2)).not.toThrow();
